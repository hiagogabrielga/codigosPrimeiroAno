...
def mostrar():
    ...
    if resultado == []:
        ...
        if per == '1' or per == '2' or per =='3':
            if per == '1':
                resultado_p.append(linha)
                n=len(resultado)
                for i in range(n):
                    atv=resultado[i]
                    atv=list(atv)
                ...
                if resultado == []:
                    ...
                    for i in range(n):
                        ...
                        atv[0]=i+1
                        atv=tuple(atv)
                        resultado_p.append(f'|Atividade de Número: {atv[0]}|Título: {atv[1]}|Status: {atv[3]}{linha}')
                ...
                if resultado == []:
                    ...
                    for i in range(n):
                        ...
                        atv[0]=i+1
                        atv=tuple(atv)
                        resultado_p.append(f'{linha}|Atividade de Número: {atv[0]}|Título: {atv[1]}|Descrição: {atv[2]}|Status: {atv[3]}{linha}') 

                    while True:
                            try:
                                iddados_da_agenda = int(input('\nDigite o número de sua atividade: '))
                                ...
                                print('\nOps, Você adicionou um caractere inválido ao inves de um número de uma atividade. \nTente outro número.')

                    resultado_p=resultado_p[iddados_da_agenda]
                    resultado_p=str(resultado_p).replace("'",'')
                    resultado_p=str(resultado_p).replace("[",'')
                    resultado_p=str(resultado_p).replace("]",'')
                    resultado_p=str(resultado_p).replace(", ",'')
...
while True:
    print('\n========================================\
          \n| Escolha uma Opção:                    |\
          \n|=======================================|\
          \n| 1 = Mostrar atividades e descrição    |\
          \n| 2 = Mostrar atividades                |\
          \n| 3 = Mostrar descrição de uma atividade|\
          \n| 4 = Adicionar tarefa                  |\
          \n| 5 = Marcar como concluída             |\
          \n| 6 = Marcar como pendente              |\
          \n| 7 = Retirar atividades                |\
          \n| 8 = Fechar o programa                 |\
          \n=========================================\n')
