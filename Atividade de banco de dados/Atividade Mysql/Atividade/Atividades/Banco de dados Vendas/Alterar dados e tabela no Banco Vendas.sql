...
/*===================================================================== Alterar Banco de dados e tabelas ========================================================================================================*/

update endereco set tipo_local="comercio", logradouro="Rua Capitão Caverna", numero=6352 where id=3;
update endereco set tipo_local="residencial", logradouro="Rua Americana", numero=8735 where id=4;
update endereco set tipo_local="residencia", logradouro="Rua Carambola", numero=5532 where id=9;
update endereco set tipo_local="comercio", logradouro="Rua Brigadeiro", numero=3487 where id=6;
update endereco set tipo_local="residencia", logradouro="Rua Bento", numero=1232 where id=8;

alter table solicitante add nome varchar(50), add cpf varchar (11);
alter table servico add valor float;
alter table endereco drop complemento;
